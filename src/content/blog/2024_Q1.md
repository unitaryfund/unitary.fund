...
Qibo is an "end-to-end open source platform for quantum simulation, self-hosted quantum hardware control, calibration and characterization". Read more about this Mitiq release in [Francesc Sabater’s blog](https://unitary.fund/posts/adding_qibo/). 
