...
The collaboration matches competences and capabilities from academic partners, dynamic startups and SME environments including a large industry player, all with complementary roles in the project, from the glass fabrication of the photonics chips to their characterization and operation with specific software. The application QLASS algorithms will focus on is that of addressing the need for next generation Lithium ion batteries.
