---
title: "Unitary Foundation Q2 2023 Update: unitaryHACK stats, UF France, 7 new grants and projects updates"
author: Will Zeng
day: 28
month: 7
year: 2023
...
this was Unitary Foundation\'s largest event to date: **over 750 participants
...
We're also excited to announce the inauguration of [Unitary Foundation
France](https://unitary.foundation/posts/eu.html), Unitary Foundation's first
...
open-source tools by the Unitary Foundation technical staff and our
...
Alamos National Lab and Unitary Foundation tech staff showed how quantum error
...
-   **Mitiq**
    ...
    -   Talks:
        ...
        -   [SQUID](https://www.quantumcoalition.io/overview) -- Nate Stemen
            ...
            > quantum software with Unitary Foundation\"*
        ...
        -   [Silicon Valley Quantum Computing
            ...
            > *\"Unitary Foundation: Building the Open Quantum Technology
...
-   **QWorld**
    ...
    -   [QWorld Quantum Science Days 2023](https://qworld.net/qscience-days-2023/) 
        ...
        > Unitary Foundation and Classiq, and supported by the Latvian Quantum
        > Initiative. QGermany joined the QCousins network as the 26th
        > one.

-   **Qrack**

    -   The Qrack developers and Unitary Foundation wrote the [first report](https://arxiv.org/abs/2304.14969) 
        > on the design
