...
#### Q4Bio
We completed a key milestone in the Q4Bio collaboration with Pasqal and Qubit Pharmaceuticals with the release of aquapointer v0.0.1! Aquapointer is an open source software package applying quantum algorithms to find locations of water molecules in a protein cavity.
...
* [**iQuHACK**](https://www.iquise.mit.edu/iQuHACK/2024-02-02): On February 2-4, 2024 you will find Unitary Fund Technical Staff Member Dan Strano mentoring and speaking at iQuHACK, MIT's annual quantum hackathon. Students from a diverse set of backgrounds will explore improvements and applications of near-term quantum devices. 

* [**QHack**](https://qhack.ai/): Hosted between February 8-22, 2024, you will find Unitary Fund Technical Staff Member Misty Wahl giving a talk! At QHack, participants can upskill their knowledge and fast-track coding skills.
