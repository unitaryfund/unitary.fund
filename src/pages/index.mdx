...
import { ButtonLink } from '~/components/Ui'; // Assuming ButtonLink is a component for rendering links as buttons

const SurveyBanner = () => {
  return (
    <div style={styles.bannerContainer}>
      <p style={styles.bannerText}>
        The Unitary Fund 2024 Quantum Open Source Software Survey is here!{' '}
        <ButtonLink url="https://www.surveymonkey.com/r/qosssurvey24" style={styles.bannerButton}>
          Take the survey now!
        </ButtonLink>
      </p>
    </div>
...
const styles = {
  bannerContainer: {
    backgroundColor: '#f7d02c', // Gold background
    padding: '20px',
    textAlign: 'center',
    borderRadius: '8px',
    marginBottom: '20px',
