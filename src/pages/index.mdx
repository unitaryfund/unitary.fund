...
<HomeSection title="Testimonials" topSpacing="small" bottomSpacing="large">
  <TwoColumn>
    <Column>
      <Quote person="Ryan LaRose" position="Previous UF micro-grant winner and now Assistant Professor, Michigan State University">
        The Unitary Fund connected us to a larger network of quantum software developers and made clear the value of open-source contributions. We gained skills as both software engineers and research scientists as we began to tackle key challenges for the future of quantum technologies.
      </Quote>
    </Column>
    <Column>
