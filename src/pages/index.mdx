...
title: Home
bodyClassName: home
metaDescription: Unitary Fund is a 501(c)(3) non-profit helping create a quantum technology ecosystem that benefits the most people.
---
  ...
  <TwoColumn>
    <Column>
      <Quote person="Nathan Killoran" position="CTO–Software, Xanadu">
        Open-source software will be critical for an emerging technology like quantum computing, and Unitary Fund is a torchbearer in the field. We've had many great collaborations with Unitary Fund in the past, and look forward to continued work together to build the future of quantum open source.
      </Quote>
    </Column>
    <Column>
