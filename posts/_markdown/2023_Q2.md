...
-   **New** **Grants**
    ...
    -   To **[Miriam Büttner, Sunayana Dutta, Paolo Molignini, Rui Lin,
        > Camille Lévêque, Axel
        > Lode](http://ultracold.org/menu/)** to organize a
    ...
    -   To **[Eduardo
        > Maschio](https://www.linkedin.com/in/eduardomaschio)**
        > to develop
...
-   **Bra-Ket-Vue**
    ...
    -   A few years ago, we gave a UF microgrant for
        ...
        > [Crafted With
        > Code](https://www.webbyawards.com/crafted-with-code/virtual-quantum-lab/)
...
-   **QWorld**
    ...
    -   [QWorld Quantum Science Days
        > 2023](https://qworld.net/qscience-days-2023/) (QSD2023)
        > was held virtually on May 29-31 bringing researchers across
...
-   **Qrack**
    ...
    -   The Qrack developers and Unitary Fund wrote the [first
        > report](https://arxiv.org/abs/2304.14969) on the design
...
-   More [Quantum]{.ul}
    > [Wednesdays](https://unitary.fund/talks.html)!
